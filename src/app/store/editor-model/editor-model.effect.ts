...
import { ErrorMarker, ModelState, SourceType, ExerciseKey, ISeries, Exercise, Feedback } from '../../model';
import {
...
export class EditorModelEffects {
  ...
  @Effect()
  triggerValidateOnValueChange$: Observable<ModelValidateAction> = this.actions$
    .pipe(
