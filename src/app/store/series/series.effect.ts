...
export class SeriesEffects {
  ...
  loadSeries$ = this.actions$.pipe(
    ...
    switchMap((a: SeriesLoadRequest) => {
      return this.seriesService.get(a.id).pipe(
  ...
  @Effect()
  updateSeries$ = this.actions$.pipe(
    ofType(SeriesActionTypes.UPDATE_REQUEST),
    map((a: SeriesUpdateRequest) => a.series),
    concatMap((series: ISeries) => {
      return this.seriesService.update(series).pipe(
